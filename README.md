...
> Pre-1.0 (0.1.9 beta). Published via GitHub Pages until the Gradle
...
plugins { id("sh.swifttui.android") version "0.1.9" }
dependencies { implementation("sh.swifttui:android-host:0.1.9") }
