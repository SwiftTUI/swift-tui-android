...
> Pre-1.0 (0.8.7 beta). Published via GitHub Pages until the Gradle
...
plugins { id("sh.swifttui.android") version "0.8.7" }
dependencies { implementation("sh.swifttui:android-host:0.8.7") }
