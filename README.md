...
> Pre-1.0 (0.6.0 beta). Published via GitHub Pages until the Gradle
...
plugins { id("sh.swifttui.android") version "0.6.0" }
dependencies { implementation("sh.swifttui:android-host:0.6.0") }
