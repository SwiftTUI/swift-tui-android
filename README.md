...
> Pre-1.0 (0.4.3 beta). Published via GitHub Pages until the Gradle
...
plugins { id("sh.swifttui.android") version "0.4.3" }
dependencies { implementation("sh.swifttui:android-host:0.4.3") }
