...
> Pre-1.0 (0.3.8 beta). Published via GitHub Pages until the Gradle
...
plugins { id("sh.swifttui.android") version "0.3.8" }
dependencies { implementation("sh.swifttui:android-host:0.3.8") }
